      ...
      <div className="min-h-screen bg-gradient-to-br from-blue-600 to-teal-500 flex items-center justify-center p-8">
        <div className="w-full max-w-md">
          ...
          <div className="bg-white/20 backdrop-blur-xl border border-white/30 rounded-2xl p-8 shadow-2xl text-center">
            ...
            <p className="text-gray-800 mb-8 poppins-regular">
            ...
            <div className="space-y-4">
              <Button
                ...
                className="w-full bg-blue-600 hover:bg-blue-700 text-white poppins-semibold"
              >
                Sign in with Google
              </Button>
              <p className="text-xs text-gray-800 poppins-regular">
  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="max-w-md mx-auto min-h-screen relative">
        {/* Header */}
        <div className="sticky top-0 z-10 bg-white/20 backdrop-blur-xl border-b border-white/30 px-4 py-3">
          <div className="flex items-center justify-between">
            <h1 className="text-2xl font-bold text-gray-900 princess-sofia-regular poppins-bold">
              IIT Connect
            </h1>
        ...
        <div className="pb-20">
          {posts.map((post) => (
            <div key={post.id} className="mb-6 mx-4">
              ...
              <div className="bg-white/20 backdrop-blur-xl border border-white/30 rounded-2xl shadow-xl overflow-hidden">
                ...
                <div className="px-4 py-3">
                  ...
                  {/* Add Comment */}
                  <div className="flex items-center space-x-3 mt-3 pt-2 border-t border-white/20">
                    <Avatar className="h-6 w-6">
                      <AvatarImage src={session.user?.image || ""} />
                      <AvatarFallback className="bg-white/30 text-gray-900 text-xs">
                        {session.user?.name?.charAt(0)?.toUpperCase()}
                      </AvatarFallback>
                    </Avatar>
                    <input
                      ...
                      className="flex-1 text-sm focus:outline-none bg-transparent text-gray-900 placeholder-gray-600"
                    />
                    <button className="text-blue-600 font-semibold text-sm poppins-semibold">
                      Post
                    </button>
                  </div>
                </div>
        ...
        <div className="fixed bottom-0 left-1/2 transform -translate-x-1/2 w-full max-w-md bg-white/20 backdrop-blur-xl border-t border-white/30 safe-area-pb">
